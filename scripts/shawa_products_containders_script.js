document.addEventListener('DOMContentLoaded', function () {
    ...
    shaurmaItems.forEach(item => {
        item.addEventListener('mouseenter', function() {
            item.style.transform = 'scale(1.1) rotate(5deg)'; // Увеличиваем и слегка вращаем элемент
            ...
            item.style.boxShadow = '0 5px 35px rgba(0, 0, 0, 0.3)'; // Увеличиваем тень

            // Пульсирующий эффект
            item.style.animation = 'pulse 1.1s infinite'; // Пульсация при наведении
        });
        ...
        item.addEventListener('mouseleave', function() {
            ...
            // Убираем пульсацию
            item.style.animation = ''; // Останавливаем пульсирующую анимацию
        });
    });
